...
const ViewDetail = () => {
  ...
  return (
    ...
    <h1 className=" text-4xl font-semibold mt-6">
    ...
    </h1><span className=" text-sm text-primary-700 mt-3">
        Publish in 12 Mar 2024 by <b>Someone Important</b>
      </span><div className="mt-7 text-zinc-500">
        <p ref={textRef} style={{
      ...
      </div><h2 className=" text-xl font-semibold mt-8 mb-2">Resource </h2><div className="flex">
      ...
      </div><h2 className=" text-xl font-semibold mt-10 mb-2">Posted by </h2><div className="flex items-center">
        <Avatar
      ...
      </div><h2 className=" text-xl font-semibold mt-10 mb-2">Collaborated by </h2><div className='grid grid-cols-1 gap-1 place-items-start'>
        <User
          name={(<h1 className="font-semibold text-lg">Ty Sophearum</h1>)}
